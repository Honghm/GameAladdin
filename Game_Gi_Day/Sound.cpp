...
void Sound::LoadResourceSound()
{
	...
	AddSound(eSound::sound_AladdinHurt, Convert("Resources/Sound/AladdinHurt.wav"));
	AddSound(eSound::sound_GuardPant, Convert("Resources/Sound/Guard's Pants.wav"));
}
...
LPTSTR Sound::Convert(const char* path)
{
